...
public class MyContentProvider extends ContentProvider {
    static final String AUTHORITY = "com.example.app_1_provider";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        rowsDelete = db.delete(MyContentProvider.PRODUCT_TABLE,
                selection,
                selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        throw new SQLException("Failed to add to record into " + uri);
    }
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        rowsUpdated = db.update(MyContentProvider.PRODUCT_TABLE,
            values,
            selection,
            selectionArgs);
